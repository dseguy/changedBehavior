...
.. meta::
	:description:
		round() Mode Validation: The ``round()`` function has four modes, defined with four constants.
	:twitter:card: summary_large_image
	:twitter:site: @exakat
	:twitter:title: round() Mode Validation
	:twitter:description: round() Mode Validation: The ``round()`` function has four modes, defined with four constants
	:twitter:creator: @exakat
	:twitter:image:src: https://php-changed-behaviors.readthedocs.io/en/latest/_static/logo.png
	:og:image: https://php-changed-behaviors.readthedocs.io/en/latest/_static/logo.png
	:og:title: round() Mode Validation
	:og:type: article
	:og:description: The ``round()`` function has four modes, defined with four constants
