...
.. meta::
	:description:
		Inegality Comparisons: The loose comparisons, including ``=``, between integers and strings have changed in PHP 8.
	:twitter:card: summary_large_image
	:twitter:site: @exakat
	:twitter:title: Inegality Comparisons
	:twitter:description: Inegality Comparisons: The loose comparisons, including ``=``, between integers and strings have changed in PHP 8
	:twitter:creator: @exakat
	:twitter:image:src: https://php-changed-behaviors.readthedocs.io/en/latest/_static/logo.png
	:og:image: https://php-changed-behaviors.readthedocs.io/en/latest/_static/logo.png
	:og:title: Inegality Comparisons
	:og:type: article
	:og:description: The loose comparisons, including ``=``, between integers and strings have changed in PHP 8
