...
## After
```text
PHP Deprecated:  Declaring class constant called 'namespace' is deprecated in /codes/constantNamespaceInClassDeprecated.php on line 4

Deprecated: Declaring class constant called 'namespace' is deprecated in /codes/constantNamespaceInClassDeprecated.php on line 4
bar
```
## PHP version change
...
- [Declaring class constant called 'namespace' is deprecated](https://php-errors.readthedocs.io/en/latest/messages/declaring-a-class-constant-named-namespace-is-deprecated.html)
