...
## After
```text
PHP Deprecated:  Calling a function "readonly" is deprecated in /codes/readonlyFunctionCallDeprecated.php on line 7

Deprecated: Calling a function "readonly" is deprecated in /codes/readonlyFunctionCallDeprecated.php on line 7
not a property modifier
```
## PHP version change
...
- [Calling a function "readonly" is deprecated](https://php-errors.readthedocs.io/en/latest/messages/calling-a-function-%E2%80%9Creadonly%E2%80%9D-is-deprecated.html)
